...
namespace CupheadMusicPlayer.Engine.Memory
{
    public class ProgramPointer
    {
        ...
        public PointerVersion Version => (currentFinder?.Version).GetValueOrDefault(PointerVersion.Steam115);
        ...
        public void ClearPointer() => Pointer = IntPtr.Zero;
        ...
        public IntPtr GetPointer(Process program)
        {
            ...
            {
                IntPtr ptr = Pointer;
                currentFinder?.VerifyPointer(program, ref ptr);
                Pointer = ptr;
            }
        ...
        public static Tuple<IntPtr, IntPtr> GetAddressRange(Process program, string asmName)
        {
            ...
            if (module != null)
                return new Tuple<IntPtr, IntPtr>(module.BaseAddress, IntPtr.Add(module.BaseAddress, module.MemorySize));
